      ...
      <main className="flex-1 pt-28 py-16">
        <div className="max-w-4xl mx-auto px-4 sm:px-8 bg-white p-8 sm:p-12 rounded-3xl border border-slate-200 shadow-xl space-y-6">
          ...
          <div className="space-y-4 text-sm text-slate-600 leading-relaxed">
            ...
            <p>
              Your information is exclusively utilized to generate accurate line-item BOQs, conduct site engineering assessments, communicate timeline estimates, and deliver quality contracting services across PAN India. We do not sell or lease client details to third-party marketers.
            </p>
            <h3 className="text-lg font-bold text-navy-primary pt-2">3. Data Protection & Security</h3>
            <p>
            ...
            <h3 className="text-lg font-bold text-navy-primary pt-2">4. Contacting Us</h3>
            <p>
