...
export default function FlooringServicePage() {
  ...
  const flooringService = SERVICES_DATA.find((s) => s.id === 'flooring')!;
  ...
  return (
    <div className="min-h-screen bg-bg-light text-text-dark flex flex-col">
        ...
        <section className="bg-navy-dark text-white py-16 border-b border-gold-primary/30 relative overflow-hidden">
          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-8 relative z-10">
            <span className="text-gold-bright text-xs font-bold uppercase tracking-widest bg-navy-primary px-3.5 py-1 rounded-full border border-gold-primary/30">
              Industrial & High-Traffic Surfaces
            </span>
            <h1 className="text-4xl sm:text-6xl font-black text-white mt-3">
              Flooring Solutions (VDF, PCC, Epoxy & Tiles)
            </h1>
            <p className="text-slate-300 text-base sm:text-lg max-w-3xl mt-3 leading-relaxed">
              Engineered, high-load VDF vacuum dewatered concrete, self-leveling chemical epoxy coatings, concrete densification, and stone/tile laying across PAN India.
            </p>
          </div>
        </section>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-12 gap-12">
              ...
              <div className="lg:col-span-8 space-y-10">
                <div>
                  <h2 className="text-3xl font-black text-navy-primary mb-4">
                    High-End Industrial & Commercial Flooring Systems
                  </h2>
                  <p className="text-slate-600 text-base leading-relaxed">
                    {flooringService.fullDesc}
                  </p>
                </div>
                ...
                <div>
                  <h3 className="text-2xl font-extrabold text-navy-primary mb-6">
                    Flooring Specializations
                  </h3>
                  <div className="grid grid-cols-1 sm:grid-cols-2 gap-6">
                    {flooringService.subServices.map((sub, idx) => (
                ...
                <div className="bg-slate-900 text-white p-8 rounded-2xl border border-gold-primary/30">
                  ...
                  <div className="grid grid-cols-2 sm:grid-cols-4 gap-4">
                    {flooringService.technicalSpecs?.map((spec, idx) => (
              ...
              <div className="lg:col-span-4 space-y-6">
                <div className="p-6 bg-navy-primary text-white rounded-2xl border border-gold-primary/30 shadow-xl space-y-4">
                  <h3 className="text-xl font-extrabold text-gold-bright">Request Flooring Estimate</h3>
                  <p className="text-slate-300 text-xs leading-relaxed">
                    Heavy load VDF concrete or epoxy flooring inquiries receive fast technical response.
                  </p>
                  <button
                ...
                <div className="p-6 bg-slate-50 border border-slate-200 rounded-2xl space-y-3">
                  ...
                  <ul className="space-y-2 text-xs text-slate-600 font-semibold">
                    {flooringService.keyBenefits.map((b, i) => (
      ...
      <QuickQuoteModal
        ...
        defaultService="Flooring Solutions"
      />
    </div>
  );
}
