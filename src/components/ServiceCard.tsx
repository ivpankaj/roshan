...
export const ServiceCard: React.FC<ServiceCardProps> = ({ service, onOpenQuoteModal }) => {
  ...
  return (
    <div className="bg-white border border-slate-200 hover:border-gold-primary transition-all duration-300 flex flex-col overflow-hidden group hover:shadow-2xl rounded-none">
      {/* Top Image Banner */}
      <div className="relative h-56 overflow-hidden">
        ...
        {/* Badge - Sharp */}
        <div className="absolute top-4 left-4 bg-navy-primary text-gold-bright border border-gold-primary/40 text-xs font-black uppercase tracking-wider px-3 py-1 shadow-md rounded-none">
          {service.badge}
        </div>

        {/* Floating Icon - Sharp */}
        <div className="absolute -bottom-5 right-6 w-12 h-12 bg-gold-primary text-navy-dark flex items-center justify-center shadow-xl group-hover:bg-gold-bright transition-colors rounded-none border border-navy-dark">
      ...
      <div className="p-6 sm:p-8 flex-1 flex flex-col justify-between space-y-6">
        ...
        <div className="pt-6 border-t border-slate-100 flex items-center justify-between gap-3">
          ...
          <button
            ...
            className="px-4 py-2 bg-navy-primary text-gold-bright hover:bg-gold-primary hover:text-navy-dark text-xs font-bold transition-colors rounded-none uppercase tracking-wider"
          >
            Get Quote
          </button>
        </div>
