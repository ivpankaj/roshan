...
export const QuickQuoteModal: React.FC<QuickQuoteModalProps> = ({
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center p-4 sm:p-6 overflow-y-auto bg-navy-dark/85 backdrop-blur-sm animate-fade-in">
      <div className="relative w-full max-w-2xl bg-white rounded-none shadow-2xl border-2 border-gold-primary overflow-hidden my-8">
        
        {/* Modal Header */}
        <div className="bg-navy-primary px-6 py-5 text-white flex items-center justify-between border-b border-gold-primary/30">
          <div>
          ...
          <button
            onClick={onClose}
            className="p-2 text-slate-300 hover:text-white hover:bg-navy-dark transition-colors focus:outline-none rounded-none border border-transparent hover:border-gold-primary"
            ...
            <div className="py-8 text-center space-y-4">
              ...
              <div className="pt-4 flex flex-col sm:flex-row gap-3 justify-center">
                <a
                  ...
                  className="inline-flex items-center justify-center gap-2 px-6 py-3 bg-gold-primary text-navy-dark font-bold rounded-none hover:bg-gold-bright transition-colors uppercase tracking-wider text-xs"
                >
                  <PhoneCall className="w-4 h-4" /> Call Now: {COMPANY_INFO.phone}
                </a>
                <button
                  onClick={handleReset}
                  className="px-6 py-3 bg-slate-100 text-slate-700 font-semibold rounded-none hover:bg-slate-200 transition-colors uppercase tracking-wider text-xs border border-slate-300"
                >
                  Close Window
                </button>
              </div>
            ...
            <form onSubmit={handleSubmit} className="space-y-4">
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                <div>
                  ...
                  <select
                    ...
                    className="w-full px-4 py-2.5 rounded-none border border-slate-300 focus:border-gold-primary focus:ring-1 focus:ring-gold-primary outline-none text-sm text-navy-primary bg-white"
                  >
              ...
              <div>
                ...
                <textarea
                  ...
                  className="w-full px-4 py-2.5 rounded-none border border-slate-300 focus:border-gold-primary focus:ring-1 focus:ring-gold-primary outline-none text-sm text-navy-primary resize-none"
                ></textarea>
              </div>
              ...
              <div className="pt-2 flex flex-col sm:flex-row items-center justify-between gap-4">
                ...
                <button
                  ...
                  className="w-full sm:w-auto px-8 py-3.5 bg-gold-primary text-navy-dark font-extrabold rounded-none hover:bg-gold-bright transition-all shadow-lg hover:shadow-gold-primary/30 flex items-center justify-center gap-2 text-xs uppercase tracking-wider"
                >
                  {isSubmitting ? (
